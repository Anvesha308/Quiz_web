...
// CSS for glowing and floating effects
const dynamicStyles = `
  @keyframes glow {
  ...
  .floating-shape {
    animation: float var(--duration) ease-in-out infinite alternate var(--delay),
...
const FloatingShape = () => {
  ...
  const [color] = useState(() => {
    const colors = ['bg-fuchsia-500', 'bg-purple-500', 'bg-rose-500', 'bg-indigo-500'];
...
const App = () => {
    ...
    return (
      <div className="flex flex-col items-center justify-center p-4 min-h-screen font-sans z-10">
        <div className="bg-transparent text-gray-800 w-full max-w-xl mx-auto">
          <div className="text-center text-gray-600 mb-4 text-sm font-semibold">
            Question {progress}
          </div>
  ...
  return (
    <div
      className="min-h-screen relative overflow-hidden flex flex-col items-center justify-center p-4 bg-gradient-to-br from-blue-300 via-cyan-300 to-green-300"
    >
